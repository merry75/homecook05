...
router.post('/', auth.hasRole(['admin','cook']), controller.create);
router.put('/:id', auth.hasRole(['admin','cook']), controller.update);
router.patch('/:id', auth.hasRole(['admin','cook']), controller.update);
router.delete('/:id', auth.hasRole(['admin','cook']), controller.destroy);
